const en = {
  ...
  home: {
    ...
    hero: {
      ...
      subtitle: "ItemNest connects people who've lost items with those who've found them. Post in seconds, match instantly.",
      ctaLost: "Post Lost Item",
      ctaFound: "Post Found Item",
    },
  ...
  adminPages: {
    ...
    categories: {
      ...
      title: "Categories",
      description: "Manage the item categories available when creating lost or found posts.",
      backToDashboard: "Back to Admin Dashboard",
      ...
      confirmDelete: "Are you sure you want to delete this category? Posts using it may be affected.",
      successCreated: "Category was created successfully.",
      successUpdated: "Category was updated successfully.",
      successDeleted: "Category was deleted successfully.",
