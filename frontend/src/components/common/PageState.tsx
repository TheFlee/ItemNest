...
export default function PageState({ isLoading, errorMessage, emptyMessage, isEmpty }: PageStateProps) {
  ...
  if (errorMessage) {
    return (
      <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-800 dark:bg-red-950 dark:text-red-300">
